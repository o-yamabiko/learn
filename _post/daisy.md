...
DAISY 2002 や DAISY 3 の仕様は DAISY 2.02 と大きく異なるため、録音・再生環境を新たに対応させる必要がある。再生環境は DAISY 3 に対応したものがすでに多くの種類作られている[^kzakzadaisyepub]。また、マルチメディアデイジー図書作成環境も DAISY 3 に対応している。しかし、音声デイジー図書作成環境については、日本で普及している PLEXTALK 製品 (DR-1 や PRS Pro) が DAISY 3 に対応していない。
