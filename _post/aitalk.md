...
アイコンにマウスカーソルを乗せると昨日の説明がポップアップされる。よく使う機能にはショートカットキーもある。
例えば、読み上げのオン・オフは `Alt R` 、自動読み上げのオン・オフは `Alt A` である。
...
デイジー図書の音量のピークが-12dBから-6dBの間に入る程度にするには、のぞみの音量なら 2.0、せいじの音量なら 1.5 程度がちょうど良い。
